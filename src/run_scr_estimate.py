...
def main():
    ...
    #directory log, creating if it does not exisit
    #already had the directory for another reason
    #log files to debug later
    #add log file and command file
    #have a line if directory does not exist create it
    #under directory of whole project
    #in data -> project -> in project have simulation, logs
    #in data have project 1,(config, logs,  simulation)
    #have projecct 1 -> input data (tiff, csv, config)
    ...
    #this was changed
    #Why are we loading a single capture history and not all of the samples???
    ...
    #this was changed
    #check for simulate origonal if it is also 50 based on config file
    print("size of ch " + str(len(capture_histories)))
